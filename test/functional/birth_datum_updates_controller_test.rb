...
class BirthDatumUpdatesControllerTest < ActionController::TestCase
	...
	site_administrators.each do |cu|
		...
		test "should create with csv_file attachment and #{cu} login" do
			login_as send(cu)
#			create_birth_datum_update_test_file
...
#			assert_equal   assigns(:birth_datum_update).csv_file_file_name, csv_test_file_name
...
#			assert_equal   birth_datum_update.csv_file_file_name, csv_test_file_name
