...
class RafsControllerDuplicatesTest < ActionController::TestCase
	...
	#	Seems a bit excessive though.
			...
			test "should NOT create raf case study_subject" <<
					...
					" and #{cu} login" do
				subject = FactoryBot.create(:complete_control_study_subject)
				login_as send(cu)
				assert_all_differences(0) do
					post :create, minimum_raf_form_attributes(
	...
	#	mother's maiden name match
			...
			test "should NOT create raf case study_subject" <<
				...
				subject = FactoryBot.create(:complete_case_study_subject,:mother_maiden_name => 'Smith')
				login_as send(cu)
				assert_all_differences(0) do
					post :create, minimum_raf_form_attributes(
						'study_subject' => { 'sex' => subject.sex,
...
end	#	class CasesControllerDuplicatesTest < ActionController::TestCase
