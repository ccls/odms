...
module ActionControllerExtension::AccessibleViaProtocol
...
#	TODO
#	Since upgrading to Rails3, no matter what I do https is not required?
#	At least it doesn't appear to be testable?
#	It is effectively irrelevant, as the production server redirects
#	all HTTP requests to HTTPS. Because of this, the app will never
#	see a non-SSL request. I don't like that I can't test it though.
#	With config.force_ssl, I would expect some type of redirect.
#	I even put a "puts request.ssl?" in the controller and it 
#	returned "false"?  I don't understand.
#
...
end	#	module ActionControllerExtension::AccessibleViaProtocol
ActionController::TestCase.send(:include, 
	ActionControllerExtension::AccessibleViaProtocol)
