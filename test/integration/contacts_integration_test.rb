...
##			click_link '.toggle_eligibility_criteria'
		...
		test "contacts#show should not have toggle_historic_addressings link" <<
			...
			assert has_no_css?('a.toggle_historic_addressings')
			assert has_css?('div.addressings div.historic', :visible => false)
		end
		...
		test "contacts#show should not have toggle_historic_phone_numbers link" <<
			...
			assert has_no_css?('a.toggle_historic_phone_numbers')
			assert has_css?('div.phone_numbers div.historic', :visible => false)
		end
		...
		test "contacts#show should toggle historic addresses with #{cu} login" do
			...
			login_as send(cu)
			visit study_subject_contacts_path(addressing.study_subject)
			assert has_css?('a.toggle_historic_addressings')
			assert has_css?('div.addressings div.historic', :visible => false)
			find('a.toggle_historic_addressings').click
			assert has_css?('div.addressings div.historic', :visible => true)
			find('a.toggle_historic_addressings').click
			assert has_css?('div.addressings div.historic', :visible => false)
		end
		...
		test "contacts#show should toggle historic phone_numbers with #{cu} login" do
			...
			login_as send(cu)
			visit study_subject_contacts_path(phone_number.study_subject)
			assert has_css?('a.toggle_historic_phone_numbers')
			assert has_css?('div.phone_numbers div.historic', :visible => false)
			find('a.toggle_historic_phone_numbers').click
			assert has_css?('div.phone_numbers div.historic', :visible => true)
			find('a.toggle_historic_phone_numbers').click
			assert has_css?('div.phone_numbers div.historic', :visible => false)
		end
