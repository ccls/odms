...
#	I was attempting to put this code in such that
#	it would only effect code in a particular namespace.
#	I don't think that it is possible.  Once it is included,
#	it is available in ALL other rake tasks.

module OdmsImport; end
module OdmsImport::Base
...
#
#	This seems to isolate the code by including it at the task level.
#
namespace :odms_import do
	task :odms_import_base => :environment do
		include OdmsImport::Base
	end
end
