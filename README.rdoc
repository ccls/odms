...
* paths not available in helper tests??
  * NameError: undefined local variable or method `dashboard_study_subjects_path' for #<ApplicationHelperTest:0x362afa4>


* integration tests running
	* #Capybara::Driver::Webkit::WebkitInvalidResponseError: Unable to load URL: https://127.0.0.1:62152/fake_session/new
* integration tests passing
* all tests passing
* write replacement for f.error_messages
* custom error messages without attribute
...
Integration tests now ignored by autotest???
I just added a mapping in .autotest so lets see.  Testing is taking FOREVER!
...
Not all of my rails2 routes are reproducable in rails3
...
Have to find new way for custom error messages, AGAIN.




Many of my extensions and modification will never work and must simply be removed.
Most unfortunate.  I'll need to find alternatives.
...
So many changes that don't seem to be "better" just "different."

This sucks.  Shoulda stuck with Rails 2. 



At least autotest runs

Would probably be much better if I could remove all of my custom mods,
but I'll probably have to add more.
