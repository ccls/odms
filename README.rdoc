...
The testing computer must be connected to the internet or many tests will fail. 
The integration tests test javascript and the html uses google as a host.
