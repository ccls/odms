...
* test paperclip again
* test paperclip upload in production
...
* remove the special interview fields
  * could also remove the special selectors




* convert zip_codes, counties and document_versions into yml?
  * perhaps just document_versions
