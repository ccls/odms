...
Using rake sunspot:reindex instead.
 ...
 DO rake sunspot:reindex\[,Abstract\]
 DO rake sunspot:reindex\[,Sample\]
 DO rake sunspot:reindex\[,StudySubject\]
...
Testing passenger (gem)
 sudo C_INCLUDE_PATH=/opt/local/include passenger start
